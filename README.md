...
|-- controller/                legacy ROS1/Unity controller references
|-- third_party/PEARL/         current frozen semantic frontend
|-- third_party/SCLIP/         optional semantic frontend
|-- models/depth_backbone/     upstream depth-planner initialization
|-- models/baseline_v0/        best retained semantic baseline
