...
#define ROS_INFO(...) RCLCPP_INFO(rclcpp::get_logger("scalenav_graph"), __VA_ARGS__)
#define ROS_WARN(...) RCLCPP_WARN(rclcpp::get_logger("scalenav_graph"), __VA_ARGS__)
#define ROS_ERROR(...) RCLCPP_ERROR(rclcpp::get_logger("scalenav_graph"), __VA_ARGS__)
#define ROS_INFO_STREAM(...) RCLCPP_INFO_STREAM(rclcpp::get_logger("scalenav_graph"), __VA_ARGS__)
