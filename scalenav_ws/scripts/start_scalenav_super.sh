...
echo "started ScaleNav+SUPER+GCN; model=$GCN_MODEL mission_goal=/goal_pose astar_subgoal=/scalenav/local_goal executor_goal=/move_base_simple/goal prompt=$PROMPT"
wait -n $PIDS
