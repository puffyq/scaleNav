...
# ScaleNav semantic/topological route layer with EGO-Planner execution.
...
run ros2 launch baseline_adapters ego_map2.launch.py \
...
echo "started ScaleNav+EGO; mission_goal=/goal_pose local_goal=/scalenav/local_goal executor_goal=/move_base_simple/goal prompt=$PROMPT"
wait -n $PIDS
