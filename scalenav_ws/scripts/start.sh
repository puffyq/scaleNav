...
FRONTIER_SEMANTIC_NOISE_FLOOR="${FRONTIER_SEMANTIC_NOISE_FLOOR:-0.08}"
SEMANTIC_OPPORTUNITY_PERSISTENCE_FRAMES="${SEMANTIC_OPPORTUNITY_PERSISTENCE_FRAMES:-2}"
SEMANTIC_OPPORTUNITY_SWITCH_MARGIN_M="${SEMANTIC_OPPORTUNITY_SWITCH_MARGIN_M:-3.0}"
SEMANTIC_OPPORTUNITY_COOLDOWN_S="${SEMANTIC_OPPORTUNITY_COOLDOWN_S:-0.8}"
...
run ros2 launch scalenav_graph_ros2 scalenav_graph.launch.py \
  ...
  frontier_semantic_frame_budget_m:="$FRONTIER_SEMANTIC_FRAME_BUDGET_M" \
  frontier_semantic_noise_floor:="$FRONTIER_SEMANTIC_NOISE_FLOOR" \
  semantic_opportunity_persistence_frames:="$SEMANTIC_OPPORTUNITY_PERSISTENCE_FRAMES" \
  semantic_opportunity_switch_margin_m:="$SEMANTIC_OPPORTUNITY_SWITCH_MARGIN_M" \
  semantic_opportunity_cooldown_s:="$SEMANTIC_OPPORTUNITY_COOLDOWN_S" \
  semantic_opportunity_direction_tolerance_deg:="$SEMANTIC_OPPORTUNITY_DIRECTION_TOLERANCE_DEG"
